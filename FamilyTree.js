...
ysolyani = new CA('ysolyani', [], [0, 0], 8, 0);
...
tabraham = new CA('tabraham', [], [0, 0], 11, 0);
...
wmacrae = new CA('wmacrae', [], [0, 0], 8, 0);
...
tbenshac = new CA('tbenshac', [], [0, 0], 8, 0);
...
nhildebr = new CA('nhildebr', [], [0, 0], 8, 0);
...
malleyne = new CA('malleyne', [], [0, 0], 8, 0);
malleyne.addChildren([ebalkans,sjoyner]);
dbose = new CA('dbose', [], [0, 0], 8, 0);
dbose.addChildren([cclinch]);
mdickoff = new CA('mdickoff', [], [0, 0], 8, 0);
mdickoff.addChildren([mchoquet,akashr,tborenst]);
kbaysal = new CA('kbaysal', [], [0, 0], 9, 0);
...
sewillia = new CA('sewillia', [], [0, 0], 8, 0);
sewillia.addChildren([cclinch]);
svargo = new CA('svargo', [], [0, 0], 8, 0);
...
igillis = new CA('igillis', [], [0, 0], 8, 0);
...
thopper = new CA('thopper', [], [0, 0], 4, 0);
